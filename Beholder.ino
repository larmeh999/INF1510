...
void setup() 
{
  Serial.begin(9600);   // Initialiserer Serial, baud rate maa være samme for begge arduinos
...
delay(1000);
// Naar serial er tilgjengelig, les og hvis bokstaven "K" blir mottat og servo staar i 0 grader, saa skal servo snu 90 grader. 
...
delay(1000);
  ...
  // Leter etter nye RFID kort for aa lese
 ...
 //Skriver ut dataen fra kortet som er funnet 
  String content= "";
  byte letter;
  ...
  content.toUpperCase();
  //Hvis UID til kortet har riktig UID, send bokstaven "H" til serial
  if (content.substring(1) == "56 2F 50 06") // Her endres UDI for RFID kortet som skal bli godkjent
  {
